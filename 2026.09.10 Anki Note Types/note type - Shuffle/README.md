...
**v10** - in this version I made it so that the last correct sentence word is now automatically added to the input box if the word count is 6 or more. if the word count is 5 or less then dummy text should be two. also the automatic last word has this cool animation.
